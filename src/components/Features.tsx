  ...
  return <section id="performance" className="py-24">
      ...
      <div className="relative py-16 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-12 leading-relaxed font-medium text-yellow-600">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => <Card key={index} className="p-8 bg-card/70 backdrop-blur-sm border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-premium animate-slide-up" style={{
